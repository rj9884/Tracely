...
const BACKEND_URL = 'https://tracely-backend-tn5u.onrender.com/api'
...
function displaySiteScore(siteData) {
  ...
  if (viewDetailsBtn) {
    ...
    viewDetailsBtn.onclick = () => {
      chrome.tabs.create({
        url: `https://tracely-frontend.vercel.app/site/${currentDomain}`,
      })
    }
  }
}
...
if (settingsBtn) {
  settingsBtn.addEventListener('click', () => {
    chrome.tabs.create({
      url: 'https://tracely-frontend.vercel.app',
    })
  })
}
